...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      {/* ── Main content ── */}
      <main className="max-w-6xl mx-auto px-5 py-7 space-y-8">
        ...
        {!loading && !error && (
          <>
            {/* ── Recent Exams section (scrollable — supports up to ~30 entries) ── */}
            <section className="space-y-5">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Scroll to browse all exams · select one to view required documents
                  </p>
                </div>
              ...
              <ExamRow items={exams} selectedId={selectedExamId} onSelect={handleExamSelect} />
