...
import type { ExamDocument, UploadedDoc } from "../types";

interface DocSlotProps {
  doc: ExamDocument;
}

export default function DocSlot({ doc }: DocSlotProps) {
  ...
  return (
    <div className="space-y-1.5">
      ...
      {/* Specs */}
      <p className="text-[11px] text-muted-foreground leading-relaxed">{doc.specs}</p>
