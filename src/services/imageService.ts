import type { UploadImageResponse, ResizeImagePayload, ResizeImageResponse } from "../types";
 ...
 * Returns imageId and a URL to the stored image.
 */
 ...
 * Returns the fileName, downloadUrl, and final pixel dimensions.
 */
export async function resizeImage(payload: ResizeImagePayload): Promise<ResizeImageResponse> {
